$(document).ready(function(){
	...
	$("#Guilty-Crown h6").click(function(){
		myPlaylist.setPlaylist([
			{
				title:"My Dearest",
				mp3:"music/Guilty-Crown/My-Dearest.mp3"
			},
			{
				title:"Everlasting Guilty Crown",
				mp3:"music/Guilty-Crown/Everlasting-Guilty-Crown.mp3"
			}
		]);
	});
	$("#잔향의-테러 h6").click(function(){
		myPlaylist.setPlaylist([
			{
				title:"Trigger",
				mp3:"music/잔향의-테러/Trigger.mp3"
			},
			{
				title:"누군가의 바다",
				mp3:"music/잔향의-테러/누군가의-바다.mp3"
			}
		]);
	});
	$("#동쪽의-에덴 h6").click(function(){
		myPlaylist.setPlaylist([
			{
				title:"Futuristic Imagination",
				mp3:"music/동쪽의-에덴/Futuristic-Imagination.mp3"
			}
		]);
	});
	$("#어떤-과학의-초전자포 h6").click(function(){
		myPlaylist.setPlaylist([
			{
				title:"Only my Railgun",
				mp3:"music/어떤-과학의-초전자포/Only-my-Railgun.mp3"
			},
			{
				title:"Sister's Noise",
				mp3:"music/어떤-과학의-초전자포/Sister's-Noise.mp3"
			}
		]);
	});
	$("#어떤-마술의-금서목록 h6").click(function(){
		myPlaylist.setPlaylist([
			{
				title:"PSY-MISSING",
				mp3:"music/어떤-마술의-금서목록/PSY-MISSING.mp3"
			},
			{
				title:"No buts!",
				mp3:"music/어떤-마술의-금서목록/No-buts!.mp3"
			}
		]);
	});
	$("#러키스타 h6").click(function(){
		myPlaylist.setPlaylist([
			{
				title:"もってけ! セ-ラ-ふく",
				mp3:"music/러키스타/もってけ! セ-ラ-ふく.mp3"
			}
		]);
	});
	$("#미나미가 h6").click(function(){
		myPlaylist.setPlaylist([
			{
				title:"經驗値上昇中☆",
				mp3:"music/미나미가/經驗値上昇中☆.mp3"
			},
			{
				title:"ココロノツバサ",
				mp3:"music/미나미가/ココロノツバサ.mp3"
			},
			{
				title:"経験値速上々↑↑",
				mp3:"music/미나미가/経験値速上々↑↑.mp3"
			}
		]);
	});
	$("#Angel-Beats h6").click(function(){
		myPlaylist.setPlaylist([
			{
				title:"My Soul, Your Beats!",
				mp3:"music/Angel-Beats/My Soul, Your Beats!.mp3"
			},
			{
				title:"Brave Song",
				mp3:"music/Angel-Beats/Brave Song.mp3"
			}
		]);
	});
	$("#듀라라라 h6").click(function(){
		myPlaylist.setPlaylist([
			{
				title:"Uragiri no Yuuyake",
				mp3:"music/듀라라라/Uragiri no Yuuyake.mp3"
			},
			{
				title:"Complication",
				mp3:"music/듀라라라/Complication.mp3"
			}
		]);
	});
	$("#Summer-Wars h6").click(function(){
		myPlaylist.setPlaylist([
			{
				title:"Summer Wars",
				mp3:"music/Summer-Wars/Summer Wars.mp3"
			}
		]);
	});
	$("#하울의-움직이는-성 h6").click(function(){
		myPlaylist.setPlaylist([
			{
				title:"Merry-Go-Around of Life",
				mp3:"music/하울의-움직이는-성/인생의-회전목마.mp3"
			}
		]);
	});
	$("#센과-치히로의-행방불명 h6").click(function(){
		myPlaylist.setPlaylist([
			{
				title:"Always with you",
				mp3:"music/언제나-몇번이라도.mp3"
			}
		]);
	});
	$("#카니발-판타즘 h6").click(function(){
		myPlaylist.setPlaylist([
			{
				title:"Super Affection",
				mp3:"music/카니발-판타즘/Super Affection.mp3"
			},
			{
				title:"Fellows",
				mp3:"music/카니발-판타즘/Fellows.mp3"
			}
		]);
	});
	/*$("# h6").click(function(){
